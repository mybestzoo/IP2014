...
\end{theorem}
It plays an important role in the proof of the main result. A short introduction to this and related formulas can be found in \cite{K}, for more details and general theory of the Radon transfom see \cite{H}.
